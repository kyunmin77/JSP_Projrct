...
<br>
	<div>
		...
		<form action="payroll.do" method="post">
		 ...
		 <select name="sal_month" >
				<option value="1" ${picked_month == '1' ? 'selected' : ''}>1 月</option>
				<option value="2" ${picked_month == '2' ? 'selected' : ''}>2 月</option>
				<option value="3" ${picked_month == '3' ? 'selected' : ''}>3 月</option>
				<option value="4" ${picked_month == '4' ? 'selected' : ''}>4 月</option>
				<option value="5" ${picked_month == '5' ? 'selected' : ''}>5 月</option>
				<option value="6" ${picked_month == '6' ? 'selected' : ''}>6 月</option>
				<option value="7" ${picked_month == '7' ? 'selected' : ''}>7 月</option>
				<option value="8" ${picked_month == '8' ? 'selected' : ''}>8 月</option>
				<option value="9" ${picked_month == '9' ? 'selected' : ''}>9 月</option>
				<option value="10" ${picked_month == '10' ? 'selected' : ''}>10 月</option>
				<option value="11" ${picked_month == '11' ? 'selected' : ''}>11 月</option>
				<option value="12" ${picked_month == '12' ? 'selected' : ''}>12 月</option>
		</select>
	
		<input type="submit" name="sal_button" value="照会">
		</form>
	</div>
	...
	<table width=100% border="1">
		...
		<c:forEach var="salary" items="${sal_list}">
			<tr>
				<td>${salary.emp_no}</td>
