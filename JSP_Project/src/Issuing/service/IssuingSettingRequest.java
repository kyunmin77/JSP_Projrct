...
public class IssuingSettingRequest {
	private int isu_num;
	...
	public IssuingSettingRequest(int isu_num, String isu_led, String isu_pur, String emp_type, String name_kor,
			String dept, String job, Date isu_date) {
		super();
