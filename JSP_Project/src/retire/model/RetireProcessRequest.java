...
public class RetireProcessRequest {
	...
	public RetireProcessRequest(String state, int emp_no, String name_kor, String dept, String job, Date hired_date,
			String years_service, String retire_type, Date retired_date, String retire_reason, String retire_phone,
			String ret_calc_type_mid, String ret_calc_type_retire) {
		super();
		this.state = state;
		this.emp_no = emp_no;
	...
	public String toString() {
		return "RetireProcessRequest [state=" + state + ", emp_no=" + emp_no + ", name_kor=" + name_kor + ", dept="
				+ dept + ", job=" + job + ", hired_date=" + hired_date + ", years_service=" + years_service
				+ ", retire_type=" + retire_type + ", retired_date=" + retired_date + ", retire_reason=" + retire_reason
				+ ", retire_phone=" + retire_phone + ", ret_calc_type_mid=" + ret_calc_type_mid
				+ ", ret_calc_type_retire=" + ret_calc_type_retire + ", getState()=" + getState() + ", getEmp_no()="
				+ getEmp_no() + ", getName_kor()=" + getName_kor() + ", getDept()=" + getDept() + ", getJob()="
				+ getJob() + ", getHired_date()=" + getHired_date() + ", getYears_service()=" + getYears_service()
				+ ", getRetire_type()=" + getRetire_type() + ", getRetired_date()=" + getRetired_date()
				+ ", getRetire_reason()=" + getRetire_reason() + ", getRetire_phone()=" + getRetire_phone()
				+ ", getRet_calc_type_mid()=" + getRet_calc_type_mid() + ", getRet_calc_type_retire()="
				+ getRet_calc_type_retire() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
