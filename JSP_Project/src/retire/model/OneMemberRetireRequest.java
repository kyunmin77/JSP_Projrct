...
public class OneMemberRetireRequest {
		...
		public void setRetired_date(Date retire_date) {
			this.retired_date = retire_date;
		}
		...
		public String toString() {
			return "OneMemberRetireRequest [emp_no=" + emp_no + ", retire_type=" + retire_type + ", retired_date="
