package dayView.model;

import java.sql.Date;

public class DaylabView {
	...
	public DaylabView(int emp_no, String name_kor, String dept, Date datth_date, String datth_name, String datth_pay,
			String datth_payrate, String datth_payment, String datth_income_tax, String datth_local_tax,
			String datth_realpayment) {
		super();
		this.emp_no = emp_no;
