...
//  Salary 테이블에서 사용하는 목록들
	...
	public EmployeeSalary(int emp_no, String emp_type, String name_kor, Date hired_date, String dept,
			String job, String state, int sal_year, int sal_month, String sal_deg, String sal_normal,
			String sal_meal, String sal_childcare, String sal_job, String sal_car, String sal_long, String sal_duty,
			String sal_reward, String sal_vac, String ded_pen, String ded_heal, String ded_long_care, String ded_hire,
