...
import salary.service.SelectEmployeeSalaryServiceOne;
import salary.service.SelectEmployeeService;
import salary.service.SelectMonthSalaryService;

public class SalaryStatementHandler implements CommandHandler {
	// 모든 직원을 조회하는 서비스 객체
	private static final String FORM_VIEW = "/WEB-INF/view/salary/SalaryStatement.jsp"; // 모든 직원을 조회하는 뷰 페이지
	private static final String FORM_VIEW2 = "/WEB-INF/view/salary/SalaryStatement2.jsp"; // 모든 직원을 조회하는 뷰 페이지
	...
	private SelectEmployeeSalaryServiceOne selectEmployeeSalarySO = new SelectEmployeeSalaryServiceOne(); 
	@Override
...
//				Employee employee = selectEmployeeService.select(emp_no);
				EmployeeSalary sal = selectEmployeeSalarySO.EmployeeSalarySelectByNo(emp_no);
//				req.setAttribute("employee", employee);
				 ...
				 * List<EmployeeSalary> sal_list =
				 * selectMonthsalaryService.selectEmployeeSalaryMonth(sal_month);
				 * 
				 * req.setAttribute("sal_list", sal_list); req.setAttribute("picked_month",
				 * sal_month);
				 */
			}
