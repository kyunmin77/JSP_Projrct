...
public class Company {
	...
	private String calc_start;
	private String calc_end;
	...
	public Company(String cp_name, String ceo_job, String ceo_name, String bs_num, String bs_regnum, Date founded_date,
			...
			String calc_start, String calc_end, String payday, String bs_bank, String bs_account, String bs_acc_name) {
		super();
	...
	public String getCalc_start() {
		return calc_start;
	}
	public String getCalc_end() {
		return calc_end;
	}
	...
	public void setCalc_start(String calc_start) {
		this.calc_start = calc_start;
	}
	public void setCalc_end(String calc_end) {
		this.calc_end = calc_end;
	}
